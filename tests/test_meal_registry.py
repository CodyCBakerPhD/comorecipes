# def test_meal_registry(example_meal: como_recipes.Meal):
#     example_folder_path = pathlib.Path(__file__).parent / "examples" / "example_1"
#
#     example_recipe_1_markdown_file_path = example_folder_path / "example_recipe_1.md"
#     recipe = Recipe.from_markdown_file(file_path=example_recipe_1_markdown_file_path)
#
#     new_registry = como_recipes.MealRegistry()
#
