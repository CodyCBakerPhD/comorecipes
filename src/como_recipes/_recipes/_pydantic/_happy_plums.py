...
class HappyPlums(Recipe):
    ...
    measurements: tuple[Measurement, ...] = (
        IngredientRegistry.get_measurement(amount=4, unit="plums", name=""),
        IngredientRegistry.get_measurement(amount=2, unit="tbsp.", name="sugar"),
        IngredientRegistry.get_measurement(amount=1, unit="tbsp.", name="coconut oil"),
        IngredientRegistry.get_measurement(amount=1 / 4, unit="cup", name="basalmic vinegar"),
        IngredientRegistry.get_measurement(amount=1 / 8, unit="tsp.", name="vanilla extract"),
        IngredientRegistry.get_measurement(amount=1, unit="tsp.", name="chopped fresh rosemary"),
        IngredientRegistry.get_measurement(amount=1, unit="tbsp.", name="honey"),
        IngredientRegistry.get_measurement(amount=1, unit="tbsp.", name="sour cream"),
    )
