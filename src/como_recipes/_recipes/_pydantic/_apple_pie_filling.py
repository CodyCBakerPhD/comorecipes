...
class ApplePieFilling(Recipe):
    ...
    measurements: tuple[Measurement, ...] = (
        ...
        IngredientRegistry.get_measurement(amount=3, unit="lbs.", name="(about 5) Granny Smith apples"),
        ...
        IngredientRegistry.get_measurement(amount=1 / 4, unit="cup", name="brown sugar"),
        IngredientRegistry.get_measurement(amount=1, unit="tbsp.", name="lemon juice"),
        IngredientRegistry.get_measurement(amount=2, unit="tsp.", name="cinnamon"),
        IngredientRegistry.get_measurement(amount=1 / 2, unit="tsp.", name="salt"),
        IngredientRegistry.get_measurement(amount=1 / 4, unit="tsp.", name="nutmeg"),
        IngredientRegistry.get_measurement(amount=2, unit="tbsp.", name="flour"),
        IngredientRegistry.get_measurement(amount=2, unit="tbsp.", name="raw sugar"),
    )
