...
class EnchiladaSauce(Recipe):
    ...
    tags: tuple[str, ...] = ("Mexican", "Vegetarian", "Entree")
    measurements: tuple[Measurement, ...] = (
        ...
        IngredientRegistry.get_measurement(amount=1 / 4, unit="tsp.", ingredient_name="cumin"),
        IngredientRegistry.get_measurement(amount=1 / 4, unit="tsp.", ingredient_name="garlic powder"),
