...
class EnchiladaSauce(Recipe):
    ...
    measurements: tuple[Measurement, ...] = (
        IngredientRegistry.get_measurement(amount=1 / 4, unit="cup", name="vegetable oil"),
        IngredientRegistry.get_measurement(amount=1 / 8, unit="cup", name="flour"),
        IngredientRegistry.get_measurement(amount=1 / 4, unit="cup", name="dark chili powder"),
        IngredientRegistry.get_measurement(amount=8, unit="oz.", name="can tomato sauce"),
        IngredientRegistry.get_measurement(amount=3 / 2, unit="cups", name="water"),
        IngredientRegistry.get_measurement(amount=1 / 4, unit="tsp.", name="cumin"),
        IngredientRegistry.get_measurement(amount=1 / 4, unit="tsp.", name="garlic powder"),
        IngredientRegistry.get_measurement(amount=1 / 4, unit="tsp.", name="onion powder"),
