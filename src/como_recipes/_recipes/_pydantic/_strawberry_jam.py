...
class StrawberryJam(Recipe):
    ...
    measurements: tuple[Measurement, ...] = (
        IngredientRegistry.get_measurement(amount=3 / 2, unit="", name="cups of thinly sliced strawberries"),
        IngredientRegistry.get_measurement(amount=40, unit="", name="g. sugar"),
        IngredientRegistry.get_measurement(amount=40, unit="", name="g. brown sugar"),
        IngredientRegistry.get_measurement(amount=20, unit="", name="g. honey"),
        IngredientRegistry.get_measurement(amount=9 / 4, unit="tbsp.", name="cornstarch"),
        IngredientRegistry.get_measurement(amount=1 / 4, unit="", name="tsp. vanilla extract"),
        IngredientRegistry.get_measurement(amount=1 / 4, unit="tsp.", name="lime juice"),
    )
