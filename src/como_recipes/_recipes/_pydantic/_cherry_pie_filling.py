...
class CherryPieFilling(Recipe):
    ...
    instructions: list[str] = [
        (
            "Place cherries into a saucepan over medium heat and cover. Heat cherries until they release their juices "
            "and simmer 10 to 15 minutes. Stir often."
        ),
        (
            "In a bowl, whisk sugar with cornstarch until smooth. Pour mixture into cherries and juice and combine. "
